...
namespace server.Controllers
{
  ...
  public class ExternalAuthController : Controller
  {
    ...
    public ExternalAuthController(IOptions<FacebookAuthSettings> fbAuthSettingsAccessor, UserManager<EmployeeProfile> userManager, ApplicationDbContext appDbContext, IJwtFactory jwtFactory, IOptions<JwtIssuerOptions> jwtOptions)
    {
    ...
    public async Task<IActionResult> Facebook([FromBody]FacebookAuthViewModel model)
    {
      ...
      if (user == null)
      {
        var appUser = new EmployeeProfile
        {
